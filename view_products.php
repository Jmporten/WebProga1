<?php
	...
	include_once('classes/fruit_product.class.php');
	include_once('classes/veggie_product.class.php');
	session_start();
?>
...
<div id="wrapper">
    ...
    <?php
        ...
        // Typo in '$arryProductArray' -> '$aryProductArray'
            ...
            switch ($thisProduceItem->price_type) {
                ...
                case 2:
                    ...
                    <div><label for="quantity<?php echo $x ?>">Quantity Requested</label> <input
                                id="quantity<?php echo $x ?>" name="quantity<?php echo $x ?>" type="text" size="10"/>
                    </div>
                    </fieldset>
